...
const mockProjects: Project[] = [
  {
    ...
    images: ['/Residential-3.png', '/Residential-3-1.png', '/Residential-3-2.png'],
  },
  {
    id: '2',
    ...
    description: 'Published Completed',
    descriptionBold:'January 23, 2025',
    images: ['/Commercial-1.png', '/Commercial-1-1.png', '/Commercial-1-2.png'],
  },
  {
    id: '3',
    ...
    description: 'Published Completed',
    descriptionBold:'January 23, 2025',
    images: ['/Residential-4.png', '/Residential-4-1.png', '/Residential-4-2.png'],
  },
  {
    id: '4',
    ...
    description: 'Published Completed',
    descriptionBold:'January 23, 2025',
    images: ['/Residential-1.png', '/Residential-1-1.png', '/Residential-1-2.png'],
  },
  {
    id: '5',
    ...
    description: 'Published Completed',
    descriptionBold:'January 23, 2025',
    images: ['/Industrial-1.png', '/Industrial-1-1.png', '/Industrial-1-2.png'],
  },
  {
    id: '6',
    ...
    description: 'Published Completed',
    descriptionBold:'January 23, 2025',
    images: ['/Residential-2.png', '/Residential-2-1.png', '/Residential-2-2.png'],
  },
];
