...
import { QuotationV2MalayalamDocument } from "@/components/QuotationV2Malayalam";
import {
  buildQuotationV2MalayalamData,
  generateQuoteNo,
 ...
 * sessionStorage as the English v2 page does, and falls back to the sample
 * quote in development so the document can be opened directly while
 * iterating.
 */
export default function QuotationV2MalayalamView() {
