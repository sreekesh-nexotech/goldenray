...
export default function privacy(){
    return(
        <section>
            {/* legal page heading  */}
            <LegalHero title="Privacy Policy" effectiveDate=" 27-04-2025" lastUpdated="27-04-2025"/>

            {/* content */}
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-36  py-8">
                <div className="text-gray-800 space-y-10">
                    <p className="mb-4">
                        Welcome to Flarize. This Privacy Policy explains how Flarize Technologies
                        Private Limited (&quot;Flarize&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) collects, uses, shares, and
                    ...
                    <div>
                        ...
                        <div>
                            <h3 className="text-xl font-medium mb-2">b) Financial/KYC Information</h3>
                            <ul className="list-disc list-inside space-y-1 ml-4">
                                <li>PAN, Aadhaar, or other identity documents (when applying for financing)</li>
                                <li>Loan-related documents</li>
                                <li>Bank account details (only if required by the financing partner)</li>
                            </ul>
                        </div>

                        <div>
                            <h3 className="text-xl font-medium mb-2">c) Technical Information</h3>
                            <ul className="list-disc list-inside space-y-1 ml-4">
                                <li>IP address</li>
                    ...
                    <div>
                        ...
                        <ul className="list-disc list-inside space-y-1 ml-4">
                            ...
                            <li>To facilitate loan applications through our NBFC/bank partners</li>
                            <li>To send confirmations, updates, and service-related communication</li>
                    ...
                    <div>
                        ...
                        <p className="mb-2">We do not sell or rent your personal data. However, we may share your information with:</p>
                            ...
                            <ul className="list-disc list-inside space-y-1 ml-4">
                                <li>Certified vendor partners for installation and delivery coordination</li>
                                <li>Banking and NBFC partners for financing (only with your consent)</li>
                                <li>Third-party service providers (e.g., payment gateways, SMS/email services) under NDA and data protection agreements</li>
                                <li>Government or regulatory authorities, as required under applicable law</li>
                                <li>Logistics partners for fulfilling product delivery</li>
                            </ul>
                        <p>All such parties are expected to maintain confidentiality and process your data in accordance with this Policy and applicable law.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="mb-2">We use cookies and other similar technologies to:</p>
                        ...
                        <p>You may modify your browser settings to disable cookies. However, this may impact your ability to access certain features of the website.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="mb-2">We take appropriate security measures to protect your personal data, including:</p>
                        ...
                        <p>Despite our efforts, no system is 100% secure. We encourage you to use strong passwords and protect your login credentials.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="list-disc list-inside space-y-1 ml-4">
                            ...
                            <li>To comply with applicable laws (e.g., tax, accounting, KYC)</li>
                            <li>Or until you request deletion (unless retention is required by law)</li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <p>Please note that some requests may affect our ability to deliver services.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="mb-2">Flarize is not intended for children under the age of 18. We do not knowingly collect personal data from minors. If we become aware of such data, we will delete it promptly.</p>
                    </div>
                    
                    {/* third party  */}
                    <div>
                        <h2 className="text-2xl font-semibold mb-4">9. Third-Party Links</h2>
                        <p className="mb-2">Our platform may contain links to third-party websites or services. We are not responsible for the privacy practices or content of such third-party sites. Please read their privacy policies separately.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="mb-2">We may update this Privacy Policy from time to time. When we do, the &quot;Last Updated&quot; date at the top will be revised. You are advised to review the policy periodically for any changes.</p>
                    </div>

                    {/* Grievance Redressal */}
                    <div>
                        <h2 className="text-2xl font-semibold mb-4">11. Grievance Redressal</h2>
                    ...
                    <div>
                        ...
                        <p className="mb-2">This Privacy Policy is governed by the laws of India. All disputes shall be subject to the jurisdiction of the competent courts in Alappuzha, Kerala.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="mb-2">For questions or feedback about this Privacy Policy, please contact us at:</p>
                        <p>
                            📧 <Link href="mailto:support@flarize.com" className="text-blue-600 hover:underline">support@flarize.com</Link><br/>
