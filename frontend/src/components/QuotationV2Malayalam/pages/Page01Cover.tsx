// Page 1 of the Flarize quotation document (Malayalam) — Cover — Stop Worrying About Electricity Bills Forever; proposal details
        ...
        flexGrow: 1
          ...
          flexShrink: 0
            ...
            overflow: "hidden"
              ...
              }}><div className="fig-asset-efb490138fedbb55-85f393ff" style={{
                  position: "absolute",
                  left: -25.788,
                  top: -356.008,
                  width: 1294.788,
          ...
          alignSelf: "stretch"
            ...
            flexShrink: 0,
            alignSelf: "stretch"
          }}>വൈദ്യുതി ബില്ലിനെ കുറിച്ചുള്ള ആശങ്കകൾക്ക് ഇനി വിട</span><span style={{
            position: "relative",
            fontFamily: "var(--font-poppins), Poppins, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
            fontWeight: 600,
            fontSize: 24,
            ...
            flexShrink: 0,
            alignSelf: "stretch"
          }}>സുരക്ഷിതമായ ഊർജ്ജം, മികച്ച ലാഭം, ദീർഘകാല സാമ്പത്തിക സുരക്ഷ — നിങ്ങളുടെ വീടിനായി.</span></div><div style={{
          position: "relative",
          ...
          alignSelf: "stretch"
            ...
            flexShrink: 0
              ...
              overflow: "hidden",
              flexShrink: 0
            }}><svg width={42.471} height={46.000} viewBox="0 0 42.471 46.000" fill="none" style={{
                position: "absolute",
                left: 1.764,
                top: 0,
                width: 42.471,
            ...
            flexShrink: 0
              ...
              flexShrink: 0
                ...
                flexShrink: 0,
                alignSelf: "stretch"
              }}>വിജയകരമായ ഇൻസ്റ്റലേഷനുകൾ</span></div></div><div style={{
            position: "relative",
            backgroundColor: "rgba(0,0,0,0)",
            display: "flex",
            flexDirection: "row",
            ...
            flexShrink: 0
              ...
              flexShrink: 0
                ...
                flexShrink: 0,
                alignSelf: "stretch"
              }}>MNRE Government</span><span style={{
                position: "relative",
                fontFamily: "var(--font-poppins), Poppins, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
                fontWeight: 400,
                fontSize: 23,
                ...
                flexShrink: 0,
                alignSelf: "stretch"
              }}>അംഗീകൃത സ്ഥാപനം</span></div></div></div><div style={{
          position: "relative",
          overflow: "hidden",
          ...
          alignSelf: "stretch"
            ...
            flexGrow: 1
              ...
              alignSelf: "stretch"
                ...
                flexShrink: 0,
                alignSelf: "stretch"
              }}>പ്രിയ {data.firstName}</span><span style={{
                position: "relative",
                fontFamily: "var(--font-poppins), Poppins, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
                fontWeight: 400,
                fontSize: 24,
...
നിങ്ങളുടെ വീട്ടിലെ വൈദ്യുതി ഉപയോഗം, ആവശ്യകത, ബജറ്റ് എന്നിവ കണക്കിലെടുത്താണ് ഈ സോളാർ പദ്ധതി പ്രത്യേകം തയ്യാറാക്കിയിരിക്കുന്നത്. അതിനാൽ നിങ്ങൾക്ക് ആത്മവിശ്വാസത്തോടെ തീരുമാനമെടുക്കാം</span></div><div style={{
              position: "relative",
              display: "flex",
              flexDirection: "row",
              gap: 21,
              ...
              flexShrink: 0
                ...
                whiteSpace: "pre-wrap"
                  ...
                  fontWeight: 600,
                  fontSize: 24
                }}>Flarize ടീം</span></span><div className="fig-asset-3505ba533a4c31a4" style={{
                position: "relative",
                width: 154.266,
                height: 64.842,
                flexShrink: 0
              }} /><div className="fig-asset-fb37b4210913ca92-fba75ad2" style={{
                position: "relative",
                width: 94.626,
                height: 86.201,
                flexShrink: 0
          ...
          alignSelf: "stretch"
            ...
            flexShrink: 0,
            alignSelf: "stretch"
          }}>YOUR PROPOSAL DETAILS</span><div style={{
            position: "relative",
            display: "flex",
            flexDirection: "row",
            gap: 28,
            ...
            flexShrink: 0
              ...
              flexShrink: 0,
              alignSelf: "stretch"
            }}><DetailRow label="പേര്" value={data.customerName} labelWidth={200} /><DetailRow label="വിലാസം" value={data.address} labelWidth={200} /><DetailRow label="പിൻകോഡ്" value={data.pincode} labelWidth={200} /><DetailRow label="ഫോൺ നമ്പർ" value={data.phoneNumber} labelWidth={200} /><DetailRow label="നിലവിലെ വൈദ്യുതി ബിൽ" value={data.currentBill} labelWidth={200} /><DetailRow label="സോളാർ സിസ്റ്റം" value={data.systemSize} labelWidth={200} /></div><div style={{
              position: "relative",
              width: 626,
              overflow: "hidden",
              borderRadius: 16,
              ...
              flexShrink: 0,
              alignSelf: "stretch"
            }}><DetailRow label="നിർദ്ദേശം നൽകുന്നത്" value={data.quoteNo} labelWidth={260} /><DetailRow label="ക്വട്ടേഷൻ നമ്പർ" value={data.proposalBy} labelWidth={260} /><DetailRow label="തീയതി" value={data.currentDate} labelWidth={260} /><DetailRow label="കാലവധി" value={data.validUntilDate} labelWidth={260} /><DetailRow label="GST നമ്പർ" value={data.gstNo} labelWidth={260} /><DetailRow label="കമ്പനി രജിസ്ട്രേഷൻ നമ്പർ" value={data.companyRegistration} labelWidth={260} /></div></div></div><div style={{
          position: "relative",
          height: 98,
