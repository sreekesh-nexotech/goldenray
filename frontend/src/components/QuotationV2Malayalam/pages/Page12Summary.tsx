        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {data.sizeLabel} — ശുപാർശ ചെയ്യുന്ന പാക്കേജ്
                </span>
              </div>
              <div
                style={{
                ...
                >
                  {data.hasSubsidy && (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          സിസ്റ്റത്തിന്റെ മൊത്തം വില (സബ്‌സിഡിക്ക് മുമ്പ്)
                        </span>
                        <span
                          style={{
                            position: "relative",
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        നിക്ഷേപം തിരികെ ലഭിക്കാൻ വേണ്ട സമയം
                      </span>
                      <span
                        style={{
                          position: "relative",
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        EMI അടയ്ക്കുന്ന കാലത്തും പ്രതിമാസ ലാഭം
                      </span>
                      <span
                        style={{
                          position: "relative",
          ...
          >
            ...
            >
              ...
              >
                <path
                  d="M 0 13.91 L 5.241 0 L 50.748 34.006 L 0 13.91 Z"
                  fill="currentColor"
                  fillRule="nonzero"
                />
              </svg>
              ...
              >
                <path
                  d="M 0 5.942 L 3.141 0 L 20.653 23.823 L 0 5.942 Z"
                  fill="currentColor"
                  fillRule="nonzero"
                />
              </svg>
              ...
              >
                <path
                  d="M 51.726 18.421 L 47.462 37.193 L 0 0 L 51.726 18.421 Z"
                  fill="currentColor"
                  fillRule="nonzero"
                />
              </svg>
              ...
              >
                <path
                  d="M 21.672 20.123 L 18.968 28.361 L 0 0 L 21.672 20.123 Z"
                  fill="currentColor"
                  fillRule="nonzero"
                />
              </svg>
              ...
              >
                <path
                  d="M 186.458 52.346 L 35.004 52.346 L 0 0 L 151.537 0 L 186.458 52.346 Z"
                  fill="currentColor"
                  fillRule="nonzero"
                />
              </svg>
              ...
              >
                <path
                  d="M 171.129 52.319 L 35.004 52.319 L 0 0 L 136.188 0 L 171.129 52.319 Z"
                  fill="currentColor"
                  fillRule="nonzero"
                />
              </svg>
              ...
              >
                <path
                  d="M 9.728 29.992 C 8.394 30.03 7.072 29.681 5.855 28.97 C 4.639 28.26 3.561 27.207 2.698 25.886 C 0.824 22.9 -0.132 19.119 0.015 15.271 C -0.098 11.301 0.874 7.407 2.76 4.278 C 3.638 2.886 4.752 1.776 6.015 1.036 C 7.277 0.296 8.655 -0.055 10.039 0.01 C 11.359 -0.064 12.675 0.258 13.883 0.951 C 15.092 1.645 16.161 2.691 17.007 4.008 C 18.886 7.062 19.834 10.908 19.669 14.812 C 19.818 18.832 18.809 22.779 16.841 25.886 C 15.985 27.246 14.896 28.326 13.661 29.04 C 12.425 29.753 11.078 30.079 9.728 29.992 Z M 9.935 5.683 C 9.195 5.663 8.463 5.888 7.808 6.337 C 7.153 6.786 6.597 7.444 6.192 8.249 C 5.178 10.276 4.683 12.668 4.777 15.082 C 4.676 17.498 5.171 19.892 6.192 21.916 C 6.604 22.685 7.153 23.313 7.792 23.747 C 8.431 24.18 9.141 24.407 9.863 24.407 C 10.584 24.407 11.294 24.18 11.934 23.747 C 12.573 23.313 13.122 22.685 13.534 21.916 C 14.555 19.894 15.044 17.496 14.927 15.082 C 15.026 12.629 14.578 10.191 13.638 8.06 C 13.238 7.269 12.686 6.629 12.037 6.202 C 11.387 5.775 10.662 5.578 9.935 5.629 L 9.935 5.683 Z"
                  fill="currentColor"
                  fillRule="nonzero"
                />
              </svg>
              ...
              >
                <path
                  d="M 11.585 5.294 L 4.513 5.294 L 4.513 12.452 L 11.002 12.452 L 11.002 17.854 L 4.513 17.854 L 4.513 29.144 L 0 29.144 L 0 0 L 11.543 0 L 11.543 5.402 L 11.585 5.294 Z"
                  fill="currentColor"
                  fillRule="nonzero"
                />
              </svg>
              ...
              >
                <path
                  d="M 11.585 5.294 L 4.513 5.294 L 4.513 12.452 L 11.002 12.452 L 11.002 17.854 L 4.513 17.854 L 4.513 29.144 L 0 29.144 L 0 0 L 11.522 0 L 11.522 5.402 L 11.585 5.294 Z"
                  fill="currentColor"
                  fillRule="nonzero"
                />
              </svg>
              ...
              >
                <path
                  d="M 12.021 29.036 L 0 29.036 L 0 0 L 11.502 0 L 11.502 5.402 L 4.534 5.402 L 4.534 11.885 L 11.086 11.885 L 11.086 17.287 L 4.534 17.287 L 4.534 23.769 L 12.021 23.769 L 12.021 29.171 L 12.021 29.036 Z"
                  fill="currentColor"
                  fillRule="nonzero"
                />
              </svg>
              ...
              >
                ...
                >
                  <path
                    d="M 2.08 17.98 L 2.08 28.784 L 0 28.784 L 0 0.018 L 5.2 0.018 C 6.062 -0.057 6.927 0.101 7.739 0.482 C 8.552 0.863 9.295 1.46 9.921 2.233 C 11.097 3.962 11.703 6.223 11.606 8.527 C 11.649 11.031 10.932 13.456 9.609 15.279 C 8.959 16.147 8.174 16.823 7.305 17.261 C 6.437 17.699 5.506 17.889 4.576 17.818 L 2.08 17.818 L 2.08 17.98 Z M 2.08 3.206 L 2.08 14.82 L 4.409 14.82 C 5.052 14.871 5.696 14.755 6.304 14.476 C 6.911 14.198 7.469 13.764 7.945 13.199 C 8.363 12.598 8.684 11.894 8.887 11.128 C 9.091 10.362 9.174 9.551 9.13 8.743 C 9.212 7.963 9.153 7.17 8.956 6.426 C 8.76 5.682 8.433 5.007 8.001 4.457 C 7.569 3.906 7.043 3.493 6.467 3.253 C 5.89 3.012 5.278 2.95 4.68 3.071 L 2.08 3.206 Z"
                    fill="currentColor"
                    fillRule="nonzero"
                  />
                </svg>
                ...
                >
                  <path
                    d="M 10.087 28.766 L 0 28.766 L 0 0 L 9.63 0 L 9.63 3.052 L 2.184 3.052 L 2.184 12.56 L 9.047 12.56 L 9.047 15.585 L 2.184 15.585 L 2.184 25.606 L 10.046 25.606 L 10.046 28.766 L 10.087 28.766 Z"
                    fill="currentColor"
                    fillRule="nonzero"
                  />
                </svg>
                ...
                >
                  <path
                    d="M 5.928 0.054 L 5.928 2.944 L 4.056 2.944 L 4.056 25.795 L 5.928 25.795 L 5.928 28.82 L 0 28.82 L 0 25.795 L 1.976 25.795 L 1.976 2.89 L 0.104 2.89 L 0.104 0 L 5.928 0 L 5.928 0.054 Z"
                    fill="currentColor"
                    fillRule="nonzero"
                  />
                </svg>
                ...
                >
                  <path
                    d="M 16.888 28.631 L 14.455 28.631 L 12.375 20.528 L 4.368 20.528 L 2.496 28.631 L 0 28.631 L 7.279 0 L 9.671 0 L 16.888 28.631 Z M 11.751 17.422 L 8.735 5.186 C 8.592 4.568 8.487 3.935 8.423 3.295 C 8.342 3.934 8.231 4.565 8.091 5.186 L 5.096 17.422 L 11.751 17.422 Z"
                    fill="currentColor"
                    fillRule="nonzero"
                  />
                </svg>
                ...
                >
                  <path
                    d="M 9.9 28.766 L 0 28.766 L 0 0 L 2.246 0 L 2.246 25.606 L 9.9 25.606 L 9.9 28.766 Z"
                    fill="currentColor"
                    fillRule="nonzero"
                  />
                </svg>
            ...
            >
              ...
              >
                10 ദിവസത്തിനുള്ളിൽ മുൻഗണനാ ഇൻസ്റ്റലേഷൻ
              </span>
              <span
                style={{
                  position: "relative",
              ...
              >
                വേഗത്തിലുള്ള ഷെഡ്യൂളിംഗും ഇൻസ്റ്റലേഷനും
              </span>
              <span
                style={{
                  position: "relative",
              ...
              >
                {data.offerValidDate}-ന് മുമ്പ് ബുക്കിംഗ് സ്ഥിരീകരിക്കുന്നവർക്ക്
                മാത്രം
              </span>
            </div>
          </div>
