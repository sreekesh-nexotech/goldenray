// Page 8 of the Flarize quotation document (Malayalam) — Your Savings Over Time — savings chart + payback
        ...
        flexGrow: 1
          ...
          alignSelf: "stretch"
            ...
            flexShrink: 0
              ...
              alignSelf: "stretch"
                ...
                color: "rgb(17,24,39)",
                flexShrink: 0
              }}>കാലക്രമേണ ഉള്ള ലാഭം</span></div><div style={{
              position: "relative",
              height: 414,
              backgroundColor: "rgba(0,0,0,0)",
              flexShrink: 0,
              alignSelf: "stretch"
                ...
                flexWrap: "nowrap"
                  ...
                  alignSelf: "stretch"
                    ...
                    flexShrink: 0,
                    alignSelf: "stretch"
                  }}>നിങ്ങളുടെ വൈദ്യുതി ബില്ലിലെ കുറവ്</span><div style={{
                    position: "relative",
                    backgroundColor: "rgba(0,0,0,0)",
                    display: "flex",
                    flexDirection: "row",
                  ...
                  alignSelf: "stretch"
                    ...
                    flexGrow: 1
                      ...
                      flexShrink: 0,
                      alignSelf: "stretch"
                    }}>25 വർഷത്തെ ആകെ ലാഭം</span><span style={{
                      position: "relative",
                      fontFamily: "var(--font-poppins), Poppins, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
                      fontWeight: 700,
                      fontSize: 26,
                  ...
                  alignSelf: "stretch"
                    ...
                    flexShrink: 0,
                    alignSelf: "stretch"
                  }}>ഏകദേശം 25 മാസത്തിനുള്ളിൽ നിങ്ങളുടെ സോളാർ സിസ്റ്റം സ്ഥാപിക്കാനുള്ള ചിലവ് തിരികെ കണ്ടെത്താം.</span></div></div></div></div></div><div style={{
          position: "relative",
          width: 1280,
          backgroundColor: "rgba(0,0,0,0)",
          display: "flex",
          ...
          flexShrink: 0
            ...
            flexGrow: 1
              ...
              alignSelf: "stretch"
                ...
                color: "rgb(220,38,38)",
                flexShrink: 0
              }}>Solar ഇല്ലെങ്കിൽ</span></div><div style={{
              position: "relative",
              backgroundColor: "rgba(0,0,0,0)",
              display: "flex",
              flexDirection: "column",
              ...
              alignSelf: "stretch"
                ...
                flexShrink: 0
                  ...
                  flexShrink: 0
                    ...
                    color: "rgb(220,38,38)",
                    fontSize: 24
                  }}> 8-12% വർധിക്കും</span></span></div><div style={{
                position: "relative",
                width: 432,
                backgroundColor: "rgba(0,0,0,0)",
                display: "flex",
            ...
            flexGrow: 1
              ...
              alignSelf: "stretch"
                ...
                color: "var(--green)",
                flexShrink: 0
              }}>Solar ഉണ്ടെങ്കിൽ</span></div><div style={{
              position: "relative",
              backgroundColor: "rgba(0,0,0,0)",
              display: "flex",
              flexDirection: "column",
              ...
              alignSelf: "stretch"
                ...
                flexShrink: 0
                  ...
                  display: "inline-block"
                    ...
                    color: "rgb(68,68,68)",
                    fontSize: 24
                  }}>ഭാവിയിലെ വൈദ്യുതി നിരക്ക് വർധനവിൽ നിന്നും</span><span style={{
                    color: "rgb(22,163,74)",
                    fontSize: 24
                ...
                flexShrink: 0
                  ...
                  display: "inline-block"
                    ...
                    color: "rgb(22,163,74)",
                    fontSize: 24
                  }}> Warranty സംരക്ഷണം</span></span></div></div></div></div><div style={{
          position: "relative",
          display: "flex",
          flexDirection: "column",
          gap: 24,
          ...
          alignSelf: "stretch"
            ...
            alignSelf: "stretch"
              ...
              color: "rgb(18,53,50)",
              flexShrink: 0
            }}>ഇപ്പോൾ ബുക്ക് ചെയ്യൂ</span></div><div style={{
            position: "relative",
            display: "flex",
            flexDirection: "row",
            gap: 24,
              ...
              flexGrow: 1
                ...
                alignSelf: "stretch"
                  ...
                  alignSelf: "stretch"
                    ...
                    flexShrink: 0,
                    alignSelf: "stretch"
                  }}>ബാങ്ക് ട്രാൻസ്ഫർ</span><span style={{
                    position: "relative",
                    fontFamily: "var(--font-poppins), Poppins, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
                    fontWeight: 500,
                    fontSize: 26,
...
Branch: <span style={{
                    ...
                    flexShrink: 0,
                    alignSelf: "stretch"
                  }}>UPI Ref / NEFT Ref നമ്പർ നിങ്ങളുടെ Project ID ആയി പരിഗണിക്കും</span></div></div></div></div></div><div style={{
          position: "relative",
          overflow: "hidden",
