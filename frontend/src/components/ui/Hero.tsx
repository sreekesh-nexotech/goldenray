...
export default function Hero({ title, description }: HeroProps) {
  return (
    <section className="relative w-full  overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 pt-32 pb-16 md:pt-48 md:pb-32 max-w-7xl flex flex-col md:flex-row items-center h-full lg:gap-40 gap-0">
