...
export default function Page08Savings({
  className,
  style,
  data,
}: Page08SavingsProps) {
        ...
        >
              ...
              >
                ...
                >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <path
                                  d="M 20.559 10.063 C 21.145 9.477 21.145 8.525 20.559 7.939 L 13.059 0.439 C 12.473 -0.146 11.522 -0.146 10.936 0.439 C 10.35 1.025 10.35 1.977 10.936 2.563 L 15.881 7.504 L 1.5 7.504 C 0.67 7.504 0 8.174 0 9.004 C 0 9.833 0.67 10.504 1.5 10.504 L 15.877 10.504 L 10.941 15.444 C 10.355 16.03 10.355 16.982 10.941 17.568 C 11.527 18.154 12.478 18.154 13.064 17.568 L 20.564 10.068 L 20.559 10.063 Z"
                                  fill="currentColor"
                                  fillRule="nonzero"
                                />
                              </svg>
                  ...
                  >
                    ...
                    >
                      In just {data.paybackMonths}, your solar system pays for
                      itself. The next 25 years are pure savings.
                    </span>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <path
                    d="M 10 20 C 12.652 20 15.196 18.946 17.071 17.071 C 18.946 15.196 20 12.652 20 10 C 20 7.348 18.946 4.804 17.071 2.929 C 15.196 1.054 12.652 0 10 0 C 7.348 0 4.804 1.054 2.929 2.929 C 1.054 4.804 0 7.348 0 10 C 0 12.652 1.054 15.196 2.929 17.071 C 4.804 18.946 7.348 20 10 20 Z M 6.836 6.836 C 7.203 6.469 7.797 6.469 8.16 6.836 L 9.996 8.672 L 11.832 6.836 C 12.199 6.469 12.793 6.469 13.156 6.836 C 13.52 7.203 13.523 7.797 13.156 8.16 L 11.32 9.996 L 13.156 11.832 C 13.523 12.199 13.523 12.793 13.156 13.156 C 12.789 13.52 12.195 13.523 11.832 13.156 L 9.996 11.32 L 8.16 13.156 C 7.793 13.523 7.199 13.523 6.836 13.156 C 6.473 12.789 6.469 12.195 6.836 11.832 L 8.672 9.996 L 6.836 8.16 C 6.469 7.793 6.469 7.199 6.836 6.836 Z"
                    fill="currentColor"
                    fillRule="nonzero"
                  />
                </svg>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <path
                            d="M 2.5 1.25 C 2.5 0.559 1.941 0 1.25 0 C 0.559 0 0 0.559 0 1.25 L 0 14.375 C 0 16.102 1.398 17.5 3.125 17.5 L 18.75 17.5 C 19.441 17.5 20 16.941 20 16.25 C 20 15.559 19.441 15 18.75 15 L 3.125 15 C 2.781 15 2.5 14.719 2.5 14.375 L 2.5 1.25 Z M 18.383 4.633 C 18.871 4.145 18.871 3.352 18.383 2.863 C 17.895 2.375 17.102 2.375 16.613 2.863 L 12.5 6.98 L 10.258 4.738 C 9.77 4.25 8.977 4.25 8.488 4.738 L 4.113 9.113 C 3.625 9.602 3.625 10.395 4.113 10.883 C 4.602 11.371 5.395 11.371 5.883 10.883 L 9.375 7.395 L 11.617 9.637 C 12.105 10.125 12.898 10.125 13.387 9.637 L 18.387 4.637 L 18.383 4.633 Z"
                            fill="currentColor"
                            fillRule="nonzero"
                          />
                        </svg>
            ...
            <div
              style={{
                ...
                borderRadius: 16,
                background:
                  "linear-gradient(117.977deg, rgb(240,253,250) -19.79%, rgb(209,250,229) 50.92%)",
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <path
                            d="M 13.889 3.375 L 13.889 3.4 C 13.705 3.386 13.521 3.375 13.333 3.375 L 8.889 3.375 C 8.316 3.375 7.76 3.449 7.229 3.586 C 7.226 3.516 7.222 3.445 7.222 3.375 C 7.222 1.512 8.715 0 10.556 0 C 12.396 0 13.889 1.512 13.889 3.375 Z M 13.333 4.5 C 13.455 4.5 13.576 4.504 13.694 4.511 C 13.84 4.521 13.986 4.535 14.132 4.556 C 14.743 3.836 15.653 3.375 16.667 3.375 L 17.066 3.375 C 17.427 3.375 17.691 3.72 17.604 4.075 L 17.125 6.015 C 17.674 6.536 18.122 7.168 18.427 7.875 L 18.889 7.875 C 19.503 7.875 20 8.378 20 9 L 20 12.375 C 20 12.997 19.503 13.5 18.889 13.5 L 17.778 13.5 C 17.462 13.925 17.087 14.305 16.667 14.625 L 16.667 16.875 C 16.667 17.497 16.17 18 15.556 18 L 14.444 18 C 13.83 18 13.333 17.497 13.333 16.875 L 13.333 15.75 L 8.889 15.75 L 8.889 16.875 C 8.889 17.497 8.392 18 7.778 18 L 6.667 18 C 6.052 18 5.556 17.497 5.556 16.875 L 5.556 14.625 C 4.344 13.704 3.517 12.294 3.361 10.688 L 2.361 10.688 C 1.056 10.688 0 9.619 0 8.297 C 0 6.975 1.056 5.906 2.361 5.906 L 2.5 5.906 C 2.962 5.906 3.333 6.282 3.333 6.75 C 3.333 7.218 2.962 7.594 2.5 7.594 L 2.361 7.594 C 1.979 7.594 1.667 7.91 1.667 8.297 C 1.667 8.684 1.979 9 2.361 9 L 3.444 9 C 3.865 6.898 5.448 5.221 7.483 4.683 C 7.931 4.563 8.403 4.5 8.889 4.5 L 13.333 4.5 Z M 15.556 9.281 C 15.556 9.057 15.468 8.843 15.311 8.685 C 15.155 8.526 14.943 8.438 14.722 8.438 C 14.501 8.438 14.289 8.526 14.133 8.685 C 13.977 8.843 13.889 9.057 13.889 9.281 C 13.889 9.505 13.977 9.72 14.133 9.878 C 14.289 10.036 14.501 10.125 14.722 10.125 C 14.943 10.125 15.155 10.036 15.311 9.878 C 15.468 9.72 15.556 9.505 15.556 9.281 Z"
                            fill="currentColor"
                            fillRule="nonzero"
                          />
                        </svg>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <path
                            d="M 10 0 C 10.192 0 10.383 0.041 10.558 0.12 L 18.404 3.415 C 19.321 3.798 20.004 4.693 20 5.774 C 19.979 9.865 18.279 17.35 11.1 20.753 C 10.404 21.082 9.596 21.082 8.9 20.753 C 1.721 17.35 0.021 9.865 0 5.774 C -0.004 4.693 0.679 3.798 1.596 3.415 L 9.446 0.12 C 9.617 0.041 9.808 0 10 0 Z M 10 2.755 L 10 18.344 C 15.75 15.589 17.296 9.49 17.333 5.832 L 10 2.755 Z"
                            fill="currentColor"
                            fillRule="nonzero"
                          />
                        </svg>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <div
                    className="fig-asset-0701f7494693611f-5d8c127c"
                    style={{
                      position: "relative",
                      height: 269,
                      display: "flex",
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Golden Ray Renewable Energy LLP
                      </span>
                      <br />
                      A/c No:{" "}
                      <span
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    2. Proof of Identity (Aadhar & PAN Card)
                  </span>
                  <span
                    style={{
                      position: "relative",
                  ...
                  >
                    4. Salary Slips/Bank Statements (above 2L)
                  </span>
                  <span
                    style={{
                      position: "relative",
          ...
          >
            ...
            >
              ...
              >
                Additional Structure cost ( if needed)
              </span>
              <span
                style={{
                  position: "relative",
