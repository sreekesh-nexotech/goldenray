      ...
      boxSizing: "border-box"
        ...
        flexGrow: 1
          ...
          alignSelf: "stretch"
            ...
            alignSelf: "stretch",
            whiteSpace: "pre-wrap"
          }}>Homeowners Around You Have Already <span style={{
              color: "rgb(248,138,34)"
            }}>Switched to Solar</span></span><span style={{
            position: "relative",
            width: 616,
            fontFamily: "var(--font-poppins), Poppins, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
            fontWeight: 500,
            ...
            color: "var(--grey)",
            flexShrink: 0
          }}>While you&apos;re still paying full KSEB bills every month</span></div><div style={{
          position: "relative",
          width: 1322,
          overflow: "hidden",
          borderRadius: 28,
          ...
          flexShrink: 0
            ...
            flexGrow: 1
              ...
              flexShrink: 0,
              alignSelf: "stretch"
            }}>📹 Watch Real Kerala Homeowners Share Their Experience</span><span style={{
              position: "relative",
              fontFamily: "var(--font-poppins), Poppins, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
              fontWeight: 400,
              fontSize: 24,
              ...
              flexShrink: 0,
              alignSelf: "stretch"
            }}>Scan the QR code to watch 2-minute video interviews with customers in Alappuzha, Kochi, and Thrissur. See their rooftop installations and hear their savings stories.</span><span style={{
              position: "relative",
              fontFamily: "var(--font-poppins), Poppins, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
              fontWeight: 400,
              fontSize: 24,
