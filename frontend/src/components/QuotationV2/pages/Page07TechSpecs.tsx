...
export default function Page07TechSpecs({
  className,
  style,
  data,
}: Page07TechSpecsProps) {
  return (
    <div
      className={className}
      style={{
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    (Equivalent to {data.equivalentWatts})
                  </span>
                </span>
              </div>
              <span
              ...
              >
                Every component, every specification — total transparency for
                your peace of mind.
              </span>
            </div>
            <div
            ...
            >
              <div
                style={{
                  ...
                  borderLeft: "1px solid rgba(204,205,208,0.63)",
                  display: "flex",
                  flexDirection: "row",
                  gap: 10,
              ...
              <div
                style={{
                  ...
                  backgroundColor: "rgb(255,255,255)",
                  borderTop: "1px solid rgba(68,68,68,0.41)",
                  borderRight: "1px solid rgba(68,68,68,0.41)",
                  borderBottom: "1px solid rgba(68,68,68,0.41)",
                  borderLeft: "1px solid rgba(68,68,68,0.41)",
                  display: "flex",
                  flexDirection: "row",
                  gap: 10,
                  padding: "32px 20px 32px 20px",
              ...
              >
                ...
                >
                  Emmvee / Renewsys/Adani/Equivalent{" "}
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  TopCon Bifacial Glass to Glass ( 550-630W)
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  Mono PERC Bifacial Halfcut (530–560W)
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  12-Year Product & 25-30 Year Performance Warranty
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  Sungrow / Solis / Equivalent (8 Years)
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  Premier / Deye / Equivalent (7 Years)
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  GI Structure for Flat Roof - Apollo
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  GP Structure for Flat Roof - Apollo
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  ABB MCB, Citel SPD (Single Phase)
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  ETN MCB, Mersen SPD (Single Phase)
                </span>
              </div>
              <div
                style={{
              ...
              <div
                style={{
                  ...
                  borderRight: "1px solid rgb(204,205,208)",
                  borderBottom: "0.500px solid rgb(204,205,208)",
                  borderLeft: "1px solid rgb(204,205,208)",
                  display: "flex",
                  flexDirection: "row",
                  gap: 10,
                  padding: "32px 20px 32px 20px",
