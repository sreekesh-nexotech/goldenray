// Page 11 of the Flarize quotation document (English) — Terms and Conditions — items 10–17
import type { CSSProperties } from "react";

interface Page11Terms2Props {
  className?: string;
  style?: CSSProperties;
}

export default function Page11Terms2({ className, style }: Page11Terms2Props) {
        ...
        flexShrink: 0
          ...
          flexWrap: "nowrap"
            ...
            alignSelf: "stretch"
              ...
              color: "rgb(18,53,50)",
              flexShrink: 0
            }}>+91 9995 073 579</span></div></div></div></div></div>;
}
