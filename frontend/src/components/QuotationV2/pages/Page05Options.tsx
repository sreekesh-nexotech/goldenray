...
<span style={{
            ...
            flexShrink: 0
              ...
              backgroundColor: "rgb(248,138,34)",
              borderTop: "1px solid rgb(248,138,34)",
              borderRight: "1px solid rgb(248,138,34)",
              borderBottom: "1px solid rgb(248,138,34)",
              borderLeft: "1px solid rgb(248,138,34)",
              display: "flex",
              flexDirection: "row",
              gap: 10,
              ...
              alignSelf: "stretch"
                ...
                color: "var(--4)",
                flexShrink: 0
              }}>★ Recommended – Most Popular</span></div><div style={{
              position: "relative",
              backgroundColor: "rgba(0,0,0,0)",
              display: "flex",
              flexDirection: "column",
...
<span style={{
          ...
          flexShrink: 0
            ...
            borderTop: "1px solid rgba(178,178,178,0.2)",
            borderRight: "1px solid rgba(178,178,178,0.2)",
            borderBottom: "1px solid rgba(178,178,178,0.2)",
            borderLeft: "1px solid rgba(178,178,178,0.2)",
            display: "flex",
            flexDirection: "row",
            gap: 10,
...
<span style={{
            ...
            boxSizing: "border-box"
              ...
              flexShrink: 0
                ...
                height: 26.667,
                color: "var(--green-2)"
              }}><path d="M 13.333 0 C 6 0 0 6 0 13.333 C 0 20.667 6 26.667 13.333 26.667 C 20.667 26.667 26.667 20.667 26.667 13.333 C 26.667 6 20.667 0 13.333 0 Z M 10.667 20 L 4 13.333 L 5.88 11.453 L 10.667 16.227 L 20.787 6.107 L 22.667 8 L 10.667 20 Z" fill="currentColor" fillRule="nonzero" /></svg></div></div><div style={{
            gridRow: "4",
            gridColumn: "3",
            position: "relative",
            width: 318.5,
