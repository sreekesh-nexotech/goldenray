...
interface Professional {   title: string;
   desc: string;
    ...
    <section className="relative z-10 container mx-auto px-4 py-10 pb-6 md:py-20 xl:py-16 max-w-7xl flex flex-col items-center h-full gap-8">
      ...
      <div className="w-full max-w-7xl mx-auto text-center mb-8">
        ...
        <p className="hidden sm:block text-[20px] text-[#4B5563]">
          The program is open to any Kerala professional with an existing network of trust. You do not need solar industry knowledge. You do not need to close the sale. Flarize&apos;s sales team handles every technical discussion, site visit, KSEB documentation, and follow-up — from your first referral to the final installation confirmation.
        </p>
      </div>
