		...
		<>
			<section className="relative w-full overflow-hidden flex items-center lg:py-15 lg:min-h-[450px]">
				...
				<div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-start px-4 sm:px-6 md:px-8 lg:px-12 py-6 sm:py-10 md:py-16 gap-3 sm:gap-4">
					...
					<h1 className="font-semibold text-[#171717] text-lg sm:text-2xl md:text-4xl lg:text-5xl leading-snug sm:leading-tight">
						Kerala&apos;s Most Trusted Solar Brand<br />
						<span className="text-[#F88A22] font-bold">Now Paying You</span> to Refer.
					</h1>
					...
					<div className="flex flex-row gap-2 sm:gap-3 mt-2 w-full sm:w-auto text-xs lg:text-lg">
						<LinkingButton
