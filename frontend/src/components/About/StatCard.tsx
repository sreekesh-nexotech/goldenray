...
export default function StatCard({
  ...
  const renderDescription = () => {
    ...
    if (highlight && description.includes(highlight)) {
      ...
      return (
        <p className="text-xs md:text-base font-semibold leading-normal text-[#121217]">
    ...
    return (
      <p className="text-xs md:text-base font-normal leading-normal text-[#121217]">
        {description}
      </p>
    );
  };
  ...
  return (
    ...
    <div className="p-0 xl:p-6 py-10 flex flex-col items-start justify-center">
      ...
      <p className="text-xs md:text-base font-semibold leading-normal text-[#074A4D] mb-4 uppercase">
        {label}
      </p>
      {/* Display the main value of the statistic. Font sizes are adjusted as per your code. */}
      <p className="text-4xl md:text-5xl font-semibold leading-tight text-[#121217] mb-2">
        {value}
      </p>
