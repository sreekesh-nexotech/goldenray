  ...
  return (
    <section className="relative z-10 container mx-auto px-4 py-10 pb-6 md:py-20 xl:py-16 max-w-7xl flex flex-col items-center h-full gap-8">
      ...
      <div className="w-full max-w-7xl mx-auto text-center mb-8">
        ...
        <p className="hidden sm:block text-base md:text-xl font-normal md:font-semibold leading-snug text-[#4B5563]">
      ...
      <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-6">
        {QUOTES.map((q, idx) => (
          ...
          >
            <span
              className={`absolute -top-3 left-1/2 -translate-x-1/2 ${q.tagClass} text-xs md:text-base font-normal leading-normal px-3 py-1 rounded-xl whitespace-nowrap`}
            >
              {q.tag}
            </span>
            <div
              className={`text-base md:text-xl font-normal md:font-semibold leading-snug text-[#525252] mb-1 mt-2 md:mt-0`}
            >
              {q.label}
            </div>
            <div className="flex md:flex-col items-center md:items-start justify-between">
              ...
              <div className="text-sm md:text-xl font-normal leading-relaxed text-[#525252] mb-2">
                {q.system}
              </div>
            </div>
            <hr className="border-b-0 border-[#C3C1C1B2]" />
            <div className="text-sm md:text-xl font-normal leading-relaxed text-[#757575] mb-1">
              Panels:{" "}
              <span className="font-semibold text-[#444444]">{q.panels}</span>
            </div>
            <div className="text-sm md:text-xl font-normal leading-relaxed text-[#757575] mb-1">
              Inverter:{" "}
              <span className="font-semibold text-[#444444]">{q.inverter}</span>
            </div>
            <div className="text-sm md:text-xl font-normal leading-relaxed text-[#757575] mb-2">
              Structure:{" "}
              <span className="font-semibold text-[#444444]">
                {q.structure}
              </span>
            </div>
            <ul className="text-sm md:text-xl font-normal leading-relaxed text-[#074A4D] space-y-1 mt-2">
