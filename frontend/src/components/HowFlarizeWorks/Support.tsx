    ...
    icon: (
      <div className="bg-[#FFE8D7] rounded-full p-5">
        ...
        >
          ...
          <path d="M11 2H13V5H11z" />
          <path d="M19 11H22V13H19z" />
          <path d="m17,12.76v-.76c0-2.76-2.24-5-5-5s-5,2.24-5,5H3c-.35,0-.67.18-.85.47s-.2.66-.04.97l4,8c.17.34.52.55.89.55h13c.35,0,.67-.18.85-.47s.2-.66.04-.97l-3.89-7.79Zm-5-3.76c1.65,0,3,1.35,3,3h-6c0-1.65,1.35-3,3-3Zm-6.38,7l-1-2h4.51l1,2h-4.51Zm2,4l-1-2h4.51l1,2h-4.51Zm3.75-6h4.01l1,2h-4.01l-1-2Zm3,6l-1-2h4.01l1,2h-4.01Z" />
          <path d="M17.66 7.76 18.72 6.7 19.78 5.64 19.07 4.93 18.36 4.22 17.3 5.28 16.24 6.34 16.95 7.05 17.66 7.76z" />
          <path d="M6.34 7.76 7.05 7.05 7.76 6.34 6.7 5.28 5.64 4.22 4.93 4.93 4.22 5.64 5.28 6.7 6.34 7.76z" />
        </svg>
      </div>
    ),
  },
    ...
    <section className="relative z-10 container mx-auto px-4 py-10 pb-6 md:py-20 xl:py-16 max-w-7xl flex flex-col items-center h-full gap-8">
      ...
      <div className="w-full max-w-7xl mx-auto text-center mb-8">
        ...
        <p className="hidden sm:block text-sm md:text-xl font-normal leading-relaxed text-[#4B5563]">
          This is where most solar companies disappear. Flarize is built for the
          long haul — with a structured support ecosystem that covers the full
          life of your system.
        </p>
      </div>

      {/* Support Features Carousel on mobile, grid on md+ */}
      <div className="w-full max-w-7xl flex overflow-x-auto gap-4 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-6 no-scrollbar ">
