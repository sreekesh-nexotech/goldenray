    ...
    <section className="relative z-10 container mx-auto px-4 py-10 pb-6 md:py-20 xl:py-16 max-w-7xl flex flex-col items-center h-full gap-8">
      ...
      <div className="w-full max-w-7xl mx-auto text-center mb-8">
        ...
        <p className="text-[20px] text-[#4B5563]">
         We’ll call you in 15 minutes with pricing and live group status in your locality.
        </p>
      </div>

      <div className='flex flex-col sm:flex-row w-full justify-center gap-5'>
        <LinkingButton content="Reserve My Group Spot →" ButtonLink="#reserve" ButtonBg="bg-[#F7BA41]" ButtonHover="hover:bg-[#e6a73a]" Buttontext="text-[#272218]" />

        <Link href={whatsappUrl} target="_blank" className="btn border border-[#074A4D] flex items-center gap-2 bg-transparent text-[#074A4D] hover:bg-[#eeeeee] transition-all duration-200">
        <svg
