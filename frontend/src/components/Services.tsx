  ...
  return (
    ...
    <section className="py-16 sm:py-20 xl:py-12 font-inter">
      <div className="container mx-auto px-4">
        {/* Section Title */}
        <h1 className="text-3xl md:text-4xl lg:text-4xl 2xl:text-4xl font-semibold text-[#123532] mb-15 text-center">
          {serviceTitle}
        </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5  justify-items-center">
          ...
          <ServiceItem
            icon={<Image src={vector1} width={35} height={35} alt="Vector 1" />}
          ...
          <ServiceItem
            icon={<Image src={vector2} width={35} height={35} alt="Vector 1" />}
          ...
          <ServiceItem
            icon={<Image src={vector3} width={35} height={35} alt="Vector 1" />}
          ...
          <ServiceItem
            icon={<Image src={vector4} width={35} height={35} alt="Vector 1" />}
          ...
          <div className="col-span-2 md:col-span-1 justify-self-center">
            <ServiceItem
              icon={
                <Image src={vector5} width={35} height={35} alt="Vector 5" />
              }
