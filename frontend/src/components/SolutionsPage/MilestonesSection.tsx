    ...
    <section className="w-full py-12 md:py-16 lg:py-20 px-4 md:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 lg:gap-8">
          ...
          <div className="hidden md:block absolute left-0 right-0 top-[calc(50%+6.3rem)]">
            <div
          ...
          {milestones.map((milestone, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              {/* Milestone Title */}
              <h3 className="text-base md:text-xl lg:text-2xl font-semibold text-gray-900 mb-3 min-h-[3rem] flex items-center">
                {milestone.title}
              </h3>

              {/* Milestone Description */}
              <p className="text-gray-600 text-sm md:text-lg lg:text-xl mb-8 md:mb-10 max-w-xs">
                {milestone.description}
              </p>
              ...
              <div className="relative w-full flex items-center justify-center mb-8 md:mb-10">
                ...
                <div className="relative z-10 flex flex-col items-center gap-2">
                  <div className="w-16 h-16 md:w-20 md:h-20 bg-[#2C5F5D] rounded-full flex items-center justify-center">
                  ...
                  <div className="hidden md:block w-5 h-5 bg-[#FDB913] rounded-full relative z-20 border-2 border-[#2C5F5D]" />
                </div>
              </div>
