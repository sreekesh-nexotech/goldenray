// Export all SolarComparison components
export { default as SolarComparisonMain } from "./SolarComparisonMain";
export { default as SolarComparisonHero } from "./SolarComparisonHero";
