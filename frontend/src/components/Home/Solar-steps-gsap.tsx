...
export default function SolarStepsGSAP() {
  ...
  return (
    ...
    >
      <h2 className="text-4xl md:text-5xl font-semibold leading-tight text-[#123532] mb-10 text-center xl:text-left">
        ...
        {steps.map((step, index) => (
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full card-content justify-between opacity-0 translate-y-4 pointer-events-none transition-all duration-300 ease-in-out">
              <h2 className="text-4xl md:text-5xl font-semibold leading-tight md:w-2/3 mb-2 text-left">
                {step.title}
              </h2>
              <p className="text-sm md:text-xl font-normal leading-relaxed md:mb-0 mb-4 md:w-2/3 text-left">
                {step.description}
              </p>
            </div>
          </div>
