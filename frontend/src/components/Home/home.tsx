    ...
    <section className="font-switzer">
      ...
      <div className="w-full py-12 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        <h2 className=" text-4xl md:text-5xl font-semibold leading-tight text-[#123532] ">
          Solar Panel Solutions in Kerala
        </h2>
      </div>
      ...
      <SolarStepsNoGSAP />
      <Partners />
      <Booking description="Stop budgeting around your electricity bill. Get an honest assessment for a solar panel in Kerala — savings potential, system options, MNRE subsidy eligibility, and net metering benefits. No obligations, just answers from a team that’s done this 300+ times." />
