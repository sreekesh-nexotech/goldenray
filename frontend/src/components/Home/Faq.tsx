  ...
  const faqs = [
    {
      ...
      answer: 'Solar panels require minimal maintenance. Typically, they need to be cleaned a few times a year to remove dirt, dust, or debris that might accumulate and affect efficiency. Regular inspections can also help identify any potential issues early on.'
    },
    {
      question: 'Can I run my home completely on solar power?',
      answer: 'Yes, it is possible to run your home completely on solar power, especially with a properly sized system and battery storage. The feasibility depends on your energy consumption, the amount of sunlight your location receives, and the capacity of your solar system.'
    },
    {
      question: 'What is the lifespan of solar panels?',
      answer: 'Most solar panels come with a performance warranty of 20-25 years, guaranteeing a certain percentage of their original power output. However, solar panels can continue to produce electricity for 30 years or even more, albeit with a gradual decrease in efficiency over time.'
    },
    {
      question: 'How long does it take to install a solar system?',
      answer: 'The actual installation process for a residential solar system typically takes 1-3 days. However, the entire process, including design, permitting, and inspections, can take several weeks to a few months depending on local regulations and scheduling.'
    },
    {
      question: 'What is the cost of installing solar panels at home?',
      answer: 'The cost of installing solar panels varies widely based on system size, panel type, installation complexity, and location. It\'s best to get a personalized quote, but there are often government incentives and tax credits available to help offset the initial investment.'
    },
    {
      question: 'How much can I save by switching to solar?',
      answer: 'Savings from switching to solar can be substantial and depend on your current electricity rates, energy consumption, system size, and available incentives. Many homeowners see significant reductions in their monthly electricity bills, and over the lifespan of the system, the savings can amount to tens of thousands of dollars.'
    },
    {
