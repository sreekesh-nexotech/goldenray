  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 pt-28 sm:pt-32 pb-10 sm:pb-14">
        ...
        <nav
          className="flex items-center gap-1.5 text-xs md:text-base font-normal leading-normal text-[#6B7280] mb-6"
        ...
        {/* Title — centered */}
        <h1 className="text-4xl md:text-7xl font-semibold leading-tight text-[#123532] text-center mb-5 mx-auto max-w-4xl">
          {article.title}
        </h1>

        {/* Description — centered */}
        <p className="text-base md:text-xl font-normal md:font-semibold leading-snug text-[#555555] text-center mx-auto max-w-2xl">
          {article.description}
        </p>
      </div>
    </header>
