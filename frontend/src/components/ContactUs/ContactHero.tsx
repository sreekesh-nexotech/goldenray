    ...
    <div className="relative bg-white py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28 2xl:py-32 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-36 2xl:px-48">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-4xl md:text-7xl font-semibold leading-tight text-[#123532] mb-4 sm:mb-5 md:mb-6 lg:mb-7 xl:mb-8">
            Contact Us
          </h1>
          <p className="text-sm md:text-xl font-normal leading-relaxed text-[#444444] mx-auto">
